...
import { getCommentsOnBanter, deleteBanter } from "../actions/banterActions";
                    ...
                    <div className="flex-start-banter">
                      <div className="avatar-banter">
                        {!banter.userImage ? (
                          ...
                          <img
                            src={
                              "/BantedImages/profileImages/" + banter.userImage
                            }
                            alt="profile"
                          />
                        )}
                                ...
                                <div>
                                  {user.credentials[0].handle ===
                                    ...
                                    <div
                                      ...
                                      onClick={() =>
                                        dispatch(
                                          deleteBanter(banter._id, setShow)
                                        )
                                      }
                                    >
                                      <span
                    ...
                    <div className="banter-text">
                      ...
                      <div className="display">
                        {banter.banterImage.length !== 0 ? (
                          <div
                            className={getClassMediaNames(banter.banterImage)}
                          >
